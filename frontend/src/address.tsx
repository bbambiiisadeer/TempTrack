...
<div className="border-transparent bg-transparent text-sm hover:font-medium transition flex items-center h-20 px-2 relative" onClick={() => navigate("/notification")}>
Notification
{unreadCount > 0 && (
