...
function RecipientInfo() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between w-full max-w-[537px] mx-auto mb-8">
          ...
          <div className="flex-1 h-0.5 bg-gray-300 -mt-10 -ml-3.5"></div>
          ...
          <div className="flex-1 h-0.5 bg-gray-300 -mt-10 -mr-3.5"></div>
